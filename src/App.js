  ...
  const fetchMusicData = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://v1.nocodeapi.com/hello_123/spotify/NjFmFPqZwVqWHKFh/search?q=${keyword}&type=track&offset=${resultOffset}`,
        {
          headers: {
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-12 py-5 text-center">
            ...
            <h3 className="py-5">Discover music in seconds</h3>
            <div>
            </div>
          </div>
        </div>
